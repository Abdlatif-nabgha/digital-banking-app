...
public class JwtService {
    ...
    /**
     * Generates a Refresh Token (usually with a longer expiration).
     */
    ...
    /**
     * Core method to build a JWT token.
     */
    ...
    /**
     * Parses the token and retrieves all claims (payload).
     */
    ...
    /**
     * Creates a cryptographic key from the secret key string in application.yaml.
     */
